...
- **Evidence from Notes (Strict Quotes)**
  - "Need precision, not polarization towards radical extremes" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L70](input_notes/notes_2.md#L70))
  - "Expectations: - details of a prompt may have a lot of impact... - There is randomness, even exact same prompt." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L98-L100](input_notes/notes_2.md#L98-L100))
  - "Personal experiences with polluted expectations" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L220](input_notes/notes_2.md#L220))
  - "The loudest voices are rarely the best informed." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L203](input_notes/notes_1.md#L203))
...
- **Evidence from Notes (Strict Quotes)**
  - "Need precision, not polarization towards radical extremes" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L70](input_notes/notes_2.md#L70))
  - "Both tend to have polarized good vs evil beliefs." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L209](input_notes/notes_1.md#L209))
  - "The loudest voices are rarely the best informed. Useless viral content washes out boring but important developments." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L203](input_notes/notes_1.md#L203))
  - "Direct use improves skill in using a tool more appropriately and effectively." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L227](input_notes/notes_2.md#L227))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "What this isn't: AGI - just an argument over arbitrary definitions, uninteresting" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L215-L216](input_notes/notes_1.md#L215-L216))
  - "Singularity - centers on fear and hype and theory, alarmist" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L217](input_notes/notes_1.md#L217))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "What biases exactly drive opinions towards AI?" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L225](input_notes/notes_2.md#L225))
  - "Level of interest and availability strongly determine the size of exposure... Direct use improves skill..." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L227](input_notes/notes_2.md#L227))
  - "Informational asymmetry in exposure to diverse viewpoints" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L229](input_notes/notes_2.md#L229))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Might be making predictions that are correct in result, but wrong in timeline or pricing or scale." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L203](input_notes/notes_1.md#L203))
  - "Risk analysis and predictions are difficult." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L231](input_notes/notes_2.md#L231))
  - "There was a correct idea, but - wrong timing - overestimated product impact - incorrect pricing" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L160-L163](input_notes/notes_1.md#L160-L163))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "The AI evangelist" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L202](input_notes/notes_1.md#L202))
  - "The deccel" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L204](input_notes/notes_1.md#L204))
  - "Both tend to have polarized good vs evil beliefs." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L209](input_notes/notes_1.md#L209))
  - "The informed user - The now is the now." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L206-L207](input_notes/notes_1.md#L206-L207))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "We are in a hype cycle..." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L159](input_notes/notes_1.md#L159))
  - "The loudest voices are rarely the best informed. Useless viral content washes out boring but important developments." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L203](input_notes/notes_1.md#L203))
  - "incentives to gain clicks" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L188](input_notes/notes_2.md#L188))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Both tend to have polarized good vs evil beliefs." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L209](input_notes/notes_1.md#L209))
  - "The optimal solution is rarely an early iteration." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L233](input_notes/notes_2.md#L233))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Don't take headlines seriously... Read white papers. Listen to interviews with lower level engineers." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L21](input_notes/notes_2.md#L21))
  - "Everyone in the chain has some incentive... Reading closer to firsthand is much more informative." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L238](input_notes/notes_1.md#L238))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "STOP using human language" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L297](input_notes/notes_1.md#L297))
  - "Not 'having a conversation'" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L298](input_notes/notes_1.md#L298))
  - "Not 'thinking' - 'Iterative processing'" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L300-L301](input_notes/notes_1.md#L300-L301))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Firsthand engineer <-> manager <-> CEO" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L237](input_notes/notes_1.md#L237))
  - "Negative information filtered, detail and reality is polluted." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L238](input_notes/notes_1.md#L238))
  - "A tech demo is initially described as a possibility with limitations, but is often reduced to a headline that leaves this out." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L238](input_notes/notes_1.md#L238))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "this super trivial and doable thing unbelievably succeeded in this area I'm in no position to evaluate" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L221](input_notes/notes_2.md#L221))
  - "Very limited... It is impressive and not. (Dancing Bear Analogy)." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L251](input_notes/notes_1.md#L251))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Workflow vs Agent" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L273](input_notes/notes_1.md#L273))
  - "Workflows - a few LLM calls chained together. Fixed number of steps." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L276](input_notes/notes_1.md#L276))
  - "Agent - letting the LLM decide how many times to run... Open ended. Uses available tools" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L278](input_notes/notes_1.md#L278))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "RLHF stage of training takes an 'objective' model and optimizes for an explicit reward..." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L183](input_notes/notes_1.md#L183))
  - "Adding synthetic examples to training data can help." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L8](input_notes/notes_2.md#L8))
  - "insufficient training data on 'I don't know'" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L35](input_notes/notes_2.md#L35))
  - "training incentivizes a confident answer (pre training or post training w/humans)" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L36](input_notes/notes_2.md#L36))
  - "It comes optimized for local inference (quantized) and pre-trained." - [input_notes/notes_3.md](input_notes/notes_3.md) ([L57](input_notes/notes_3.md#L57))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Three things happened: - Huge developments in deep learning models - Cloud computing owned at scale... - GPU compute becoming stable." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L175-L178](input_notes/notes_1.md#L175-L178))
  - "This made the problem solvable by throwing more money, more data, more investment to drive improvement." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L179](input_notes/notes_1.md#L179))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Performance is improving here rapidly, will be one of the first things it does well and is adopted." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L80](input_notes/notes_2.md#L80))
  - "The optimal solution is rarely an early iteration." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L233](input_notes/notes_2.md#L233))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "There is randomness, even exact same prompt. You can get lucky, then unlucky..." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L100](input_notes/notes_2.md#L100))
  - "2024 paper from Gavin on why LLMs suck at logic/math" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L278](input_notes/notes_2.md#L278))
  - "Not 'thinking' - 'Iterative processing'" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L300-L301](input_notes/notes_1.md#L300-L301))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Hallucination theories: - insufficient training data on 'I don't know'" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L34-L35](input_notes/notes_2.md#L34-L35))
  - "When Plan A doesn't work, it may act unexpectedly, this is when hallucinations are seen." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L263](input_notes/notes_1.md#L263))
  - "Models are beginning to get better at 'recognizing lack of confidence in answer'." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L265](input_notes/notes_1.md#L265))
  - "At ~40% context window... you enter 'the dumb zone'" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L256](input_notes/notes_2.md#L256))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "RE: syncophancy" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L51](input_notes/notes_2.md#L51))
  - "Models should understand all values, not necessarily pander or agree with them, but be thoughtful and actively listen." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L108](input_notes/notes_2.md#L108))
  - "Every output is a great idea, 'code syncophancy.'" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L181](input_notes/notes_1.md#L181))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Domain knowledge is king..." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L150](input_notes/notes_1.md#L150))
  - "only senior engineers can determine whether output is good." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L150](input_notes/notes_1.md#L150))
  - "this super trivial and doable thing unbelievably succeeded in this area I'm in no position to evaluate" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L221](input_notes/notes_2.md#L221))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Benchmarks can be specifically targeted over time... They are inexact, not absolute." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L49](input_notes/notes_2.md#L49))
  - "It would be wrong to say they're all worthless, it would be wrong to say they can tell you everything about real world performance." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L49](input_notes/notes_2.md#L49))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "The things AI does best are the things it has the most training data on." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L190](input_notes/notes_1.md#L190))
  - "insufficient training data on 'I don't know'" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L35](input_notes/notes_2.md#L35))
  - "Don't include things like gender or race which may carry human bias from training data." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L68](input_notes/notes_1.md#L68))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Three kinds of 'mindsets' with AI programming" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L135](input_notes/notes_2.md#L135))
  - "I want to learn the best way to do the thing I am doing." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L139](input_notes/notes_2.md#L139))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Vibe coding is a slur for a reason, it's cowboy coding and hacking - rather than development." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L125](input_notes/notes_1.md#L125))
  - "Vibe coding inhibits learning, exploration accelerates it." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L146](input_notes/notes_1.md#L146))
  - "AI is often used only until it solves a problem... this is not the goal, it should be used as a learning opportunity." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L122](input_notes/notes_1.md#L122))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "the engineer won't understand it enough to fix it" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L124](input_notes/notes_1.md#L124))
  - "Only a couple people know how to use the existing database queries... This is junior engineer work, hopefully it works!" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L90](input_notes/notes_2.md#L90))
  - "Domain knowledge is king..." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L150](input_notes/notes_1.md#L150))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Asking for reasoning or steps for thoughts can help primarily with your understanding." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L14](input_notes/notes_1.md#L14))
  - "'Thinking' stage... Asking for reasoning and which steps to take prior to executing..." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L187](input_notes/notes_1.md#L187))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "The things AI does best... 1000-2000 line codebases... junior engineer work." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L190](input_notes/notes_1.md#L190))
  - "Most software needs to work most of the time... This is junior engineer work, hopefully it works!" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L90](input_notes/notes_2.md#L90))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Writing code is an art... still has value for understanding and interfacing or just writing for fun." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L96](input_notes/notes_2.md#L96))
  - "Think of a guitar player - 'I want to play the guitar' rather than 'I want a track with this guitar music.'" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L139](input_notes/notes_2.md#L139))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "'Thinking' stage... prior to executing, rather than shooting from the hip." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L187](input_notes/notes_1.md#L187))
  - "More time can be spent on planning." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L96](input_notes/notes_2.md#L96))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "After some corrections, ask 'what could have been a better prompt to describe my actual request?'" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L8](input_notes/notes_1.md#L8))
  - "iteration and correction are symptoms of good learning." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L10](input_notes/notes_1.md#L10))
  - "Accept failing results are teaching moments. Find limitations and understand why." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L44](input_notes/notes_1.md#L44))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Seek high information density. Input with fewer tokens performs better (but leave in references/examples)." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L20](input_notes/notes_1.md#L20))
  - "More tokens = worse reasoning. Eliminate fluff, don't repeat yourself." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L89](input_notes/notes_1.md#L89))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Starts with a Plan A" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L262](input_notes/notes_1.md#L262))
  - "When Plan A doesn't work, it may act unexpectedly, this is when hallucinations are seen." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L263](input_notes/notes_1.md#L263))
  - "Separate the planning context window from the 'go do the task' context window." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L254](input_notes/notes_2.md#L254))
  - "At ~40% context window... you enter 'the dumb zone'" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L256](input_notes/notes_2.md#L256))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Good prompting is similar to writing well bounded goal oriented tasks (such as in Jira)." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L20](input_notes/notes_1.md#L20))
  - "Be unambiguous" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L93](input_notes/notes_1.md#L93))
  - "Be specific about needs in YOUR detailed context." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L6](input_notes/notes_1.md#L6))
  - "Too few examples is harmful..." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L16](input_notes/notes_1.md#L16))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Think 'spartan' tone of voice." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L101](input_notes/notes_1.md#L101))
  - "Responses can vary strongly by tone." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L185](input_notes/notes_1.md#L185))
  - "Moderate politeness consistently beat both extremes." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L226](input_notes/notes_1.md#L226))
  - "Treat the intern like a colleague, you get colleague-quality work." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L230](input_notes/notes_1.md#L230))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Seek the Goldilocks zone of brief and direct while applying relevant constraints and examples." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L99](input_notes/notes_1.md#L99))
  - "Prompts should be sufficiently narrow" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L240](input_notes/notes_1.md#L240))
  - "Be terse... Be sufficiently specific. Use industry relevant language." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L244](input_notes/notes_1.md#L244))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Give it an out, 'if not clear, tag with unknown'." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L12](input_notes/notes_1.md#L12))
  - "Models are beginning to get better at 'recognizing lack of confidence in answer'." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L265](input_notes/notes_1.md#L265))
  - "Provide data and use direct sources in your answer." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L195](input_notes/notes_2.md#L195))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Phrasing and bias can drive decisions without explicit intention..." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L181](input_notes/notes_1.md#L181))
  - "Evaluating consequences and contextualization of a problem is highly subjective" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L226](input_notes/notes_2.md#L226))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "This is self contradicting, the opposite of helpful. This wastes token length without refining your prompt." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L107](input_notes/notes_1.md#L107))
  - "Separate prompts into shorter sentences" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L62](input_notes/notes_1.md#L62))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "5 STEP PROMPTING FRAMEWORK 1. TASK 2. CONTEXT" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L52-L55](input_notes/notes_1.md#L52-L55))
  - "Agentic instructions -> short and specific clear direction gives more accurate results" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L29](input_notes/notes_1.md#L29))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Use the right model for the task" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L117](input_notes/notes_1.md#L117))
  - "Don't be cheap, don't overestimate mini models for important tasks... What is your $/hour?" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L118](input_notes/notes_1.md#L118))
  - "Don't go after a fly with a bazooka." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L284](input_notes/notes_1.md#L284))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Try different modalities (share reference picture or song)" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L66](input_notes/notes_1.md#L66))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "It's an arms race no different than cyber security." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L143](input_notes/notes_1.md#L143))
  - "Cyber exploits are creative, long history of attack vectors previously unknown. Maybe more are caught." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L94](input_notes/notes_2.md#L94))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "shortened moat flooding (job applications, bug bounty programs, research paper review), an exploding signal to noise ratio" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L130](input_notes/notes_1.md#L130))
  - "\"308 users identified with over 300,000 chats. 37,500 hours of red teaming.\" Bug bounty system..." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L13](input_notes/notes_2.md#L13))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Evaluate Suitability: Ensure AI fits the task and doesn't reinforce harmful biases." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L74](input_notes/notes_1.md#L74))
  - "Limitations may be so strict it can't work in this context" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L174](input_notes/notes_2.md#L174))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "isolation from other humans (suicide, ai girlfriends)" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L129](input_notes/notes_1.md#L129))
  - "We hear about the one person led to suicide or isolation, but may not hear about the 50 who were encouraged to reach out for help." - [input_notes/notes_3.md](input_notes/notes_3.md) ([L55](input_notes/notes_3.md#L55))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "defense, finance, manufacturing should not be first adopters" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L139](input_notes/notes_1.md#L139))
  - "Defense, finance, manufacturing automation all use old technology." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L165](input_notes/notes_1.md#L165))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "makes up legal cases" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L137](input_notes/notes_1.md#L137))
  - "Give it an out, 'if not clear, tag with unknown'." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L12](input_notes/notes_1.md#L12))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "It cannot improve without orders of magnitude more high quality data... (cost, privacy, signal collection)" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L43](input_notes/notes_2.md#L43))
  - "Provide data and use direct sources in your answer." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L195](input_notes/notes_2.md#L195))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Universal Jailbreaks vs Targeted" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L305](input_notes/notes_1.md#L305))
  - "Do anything now jailbreak - applies to any question." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L307](input_notes/notes_1.md#L307))
  - "Each layer uses 'constitutional classifiers'..." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L309](input_notes/notes_1.md#L309))
  - "Examples: base64 encoding or morse code to bypass input classifier..." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L15](input_notes/notes_2.md#L15))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "LLMs tend to focus on specific things when reviewing text, kinda interesting" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L132](input_notes/notes_2.md#L132))
  - "Phrasing and bias can drive decisions without explicit intention..." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L181](input_notes/notes_1.md#L181))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "\"A critical point: ... no matter how undeniable or logical or irrefutable their arguments, many of them would turn out to be wrong\"" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L263](input_notes/notes_2.md#L263))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "The cost model changed... More code will exist doing lower value things, flooding what exists." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L191](input_notes/notes_1.md#L191))
  - "Cost per SLOC down" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L120](input_notes/notes_2.md#L120))
  - "Quality per line down on average" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L121](input_notes/notes_2.md#L121))
  - "KPIs generally up" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L125](input_notes/notes_2.md#L125))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Most software needs to work most of the time, a lower bar..." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L90](input_notes/notes_2.md#L90))
  - "This is junior engineer work, hopefully it works! We can figure out what the other engineers want and iterate." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L90](input_notes/notes_2.md#L90))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Accelerating iteration is good. This encourages refactors and redesigns." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L154](input_notes/notes_1.md#L154))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Writing code... may turn into something like playing the guitar." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L194](input_notes/notes_1.md#L194))
  - "programming may become more of a hobby. The spirit of guitar playing lives on." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L143](input_notes/notes_2.md#L143))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "More developer thinking capacity can operate at a higher level..." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L96](input_notes/notes_2.md#L96))
  - "More time can be spent on planning." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L96](input_notes/notes_2.md#L96))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Better feedback than stack overflow in your context that can accellerate knowledge." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L96](input_notes/notes_2.md#L96))
  - "Apprenticeship... Training going from 3 years to 3 months with AI training." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L162](input_notes/notes_2.md#L162))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "There is CEO lock in... you will be required to use it." - [input_notes/notes_1.md](input_notes/notes_1.md) ([L196](input_notes/notes_1.md#L196))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Specialized application software more accessible as domain experts have easier access to software development" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L168](input_notes/notes_2.md#L168))
  - "Increased specialized access... better cooperation between department silos." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L170](input_notes/notes_2.md#L170))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Experience can be be a disability. Conventional wisdom can act as a barrier." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L78](input_notes/notes_2.md#L78))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "We run out of data... It cannot improve without orders of magnitude more high quality data..." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L43](input_notes/notes_2.md#L43))
  - "We stop seeing improvement in model development - algorithms, training methods." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L45](input_notes/notes_2.md#L45))
  - "Hardware changes to be more efficient..." - [input_notes/notes_2.md](input_notes/notes_2.md) ([L47](input_notes/notes_2.md#L47))
- **Suggested Slide/Spoken Framing**
...
- **Evidence from Notes (Strict Quotes)**
  - "Medical imaging can be" - [input_notes/notes_2.md](input_notes/notes_2.md) ([L181](input_notes/notes_2.md#L181))
  - "Automation of menial / mundane tasks... Gives you more time to be human" - [input_notes/notes_1.md](input_notes/notes_1.md) ([L148](input_notes/notes_1.md#L148))
- **Suggested Slide/Spoken Framing**
